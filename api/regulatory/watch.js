...
export default async function handler(req, res) {
  try {
    ...
    const prompt = `Check latest regulatory developments. Regulator: ${body.regulator || 'RBI'}. Topic: ${body.topic || ''}. Return developments, impact, action points, risk and sources.`;
